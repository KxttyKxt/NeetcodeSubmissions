class Solution {
    public String kthDistinct(String[] arr, int k) {
		...
		// Stream<T>#distinct() only removes the (n+1)th occurrence, meaning
		//  the first occurrence of every element is preserved.
		// in this question, distinct elements are defined as elements that only appear once.
		// as such, the distinct array must be computed manually.
